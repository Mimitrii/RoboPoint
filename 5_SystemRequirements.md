...
Основной сценарий | 1. Пользователь выбрал категорю меню  <br> 2. Система выводит способы употребления пищи
Альтернативный сценарий|
Наименования элементов пользовательского интерфейса|
Диаграмма|