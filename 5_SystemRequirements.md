...
Альтернативный сценарий | AF1-2: Авторизация вместо регистрации. <br> 1. Пользователь нажал кнопку N20 <br> 2. Система отобразила страницу выбора авторизации или регистрации. Конец сценария.<br><br> AF1-4:Информация заполнена некорректно. <br> 1.Система вывела сообщение M1. Некорректно заполненная информация выделена красным цветом.  <br>  2.  Пользователь нажал кнопку N21  <br> 3. Переход к п.3 основного сценария. Конец сценария.<br><br> AF1-5:  Номер телефона уже существует в системе. <br> 1. Система вывела сообщение M2.Некорректно заполненная информация выделена красным цветом.  <br>  2.  Пользователь нажал кнопку N21  <br> 3. Переход к п.1 альтернативного сценария AF1-2. Конец сценария.<br><br> AF1-6: E-mail уже существует в системе. <br> 1. Система вывела сообщение M3. Некорректно заполненная информация выделена красным цветом.  <br>  2.  Пользователь нажал кнопку N21  <br> 3. Пользователь ввел новый E-mail и нажал кнопку N2 <br> 4. Переход к п.6 основного сценария. Конец сценария.<br><br> AF1-7:  Информация заполнена некорректно. <br> 1. Система вывела сообщение M4.Некорректно заполненная информация выделена красным цветом. <br>  2.  Пользователь нажал кнопку N21  <br> 3. Пользователь ввел в поля "Пароль" и "Повторить пароль" одинаковые значения и нажал кнопку N2 <br> 4. Переход к п.7 основного сценария. Конец сценария. <br><br> AF1-8: Корректировка данных на страницу регистрации в приложении  <br> 1.  Пользователь нажал кнопку N20 <br> 2. Система открыла страницу регистрации в приложении.Конец сценария.<br><br> AF1-9: Повторный запрос СМС <br> 1.  Пользователь нажал кнопку N3 <br> 4. Переход к п.9 основного сценария. Конец сценария.<br><br> AF1-10: Информация из СМС введена некорректно  <br> 1. Система вывела сообщение M5 <br> 2. Пользователь нажал кнопку N21  <br> 3. Пользователь ввел правильный код из СМС и нажал кнопку N2 <br> 4. Переход к п.10 основного сценария. Конец сценария.<br> 
...
Основной сценарий | 1. Пользователь нажал на кнопку N3 <br> 2. Система открыла страницу авторизации в приложении <br> 3. Пользователь заполнил номер телефона <br> 4. Пользователь ввел пароль <br> 5. Пользователь нажал кнопку N4 <br> 6. Система проверила указанный номер телефона и пароль <br> 7. Система открыла страницу с выбором категорий меню. Конец сценария.
Альтернативный сценарий |AF2-3:Восстановление пароля <br> 1.Пользователь нажал на кнопку N5 <br> 2. Система вывела диалоговое окно для ввода E-mail, указанного при регистрации <br> 3.Пользователь ввел E-mail и нажал кнопку N6 <br> 4.Система отправила новый пароль на указанный E-mail<br> 5. Переход к п.4 основного сценария. Конец сценария.<br><br> AF2-4: Использование E-mail для авторизации <br> 1. Пользователь ввел E-mail <br> 2. Переход к п.4 основного сценария. Конец сценария.<br><br> AF2-5:Информация введена некорректно <br> 1. Система вывела сообщение M6 <br> 2. Переход к п.3 основного сценария. Конец сценария.<br> 
Наименования элементов пользовательского интерфейса| N3: "Авторизоваться" <br> N4: "Войти" <br> N5: “Восстановить пароль” <br> N6: “Отправить” <br> M6: "Введен не правильный логин/пароль"
