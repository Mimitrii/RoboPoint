...
Альтернативный сценарий|  AF4-4: Без просмотра корзины <br> 4.1. Пользователь выполнил п.1-п.4 основного сценария. Конец сценария.<br>  AF4-10: Изменение количества блюд <br> 10.1 
 AF4-11: Удаление всех блюд из корзины <br> 

Наименования элементов пользовательского интерфейса|N9: "Категория меню" <br> N10:"Блюдо" <br> N11:"Корзина" <br>  N20: "Назад" .
Диаграмма|
