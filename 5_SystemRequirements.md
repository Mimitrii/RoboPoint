...
Основной сценарий | 1. Пользователь нажал на кнопку N26  <br> 2. Система расчитала допустимое количество баллов для списания <br> 3. Система проверила наличие баллов  <br> 4. Система уменьшила количество баллов в интерфейсе Приложения <br> 5. Система добавила строчку T1 на странице оплаты заказа <br> 6. Система добавила строчку T2 на странице оплаты заказа. Конец сценария. 
Альтернативный сценарий|AF10-1: 
Наименования элементов пользовательского интерфейса|N26: "Списать баллы" <br> T1:"Списанно баллов" <br> T2:"Итого с учетом скидки" 
Диаграмма|
