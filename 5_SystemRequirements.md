...
Альтернативный сценарий| AF6-1a: Употребление пищи в ресторане <br> 1a.1 Пользователь нажал на кнопку N17 <br> 1a.2  Система добавила в заказ способ употребления пищи <br> 1a.3 Система открыла страницу времени приготовления блюд. Конец сценария <br><br> AF6-1b: Изменение наполнения корзины <br> 1b.1 Пользователь нажал на кнопку N20 <br> 1b.2 Система открыла корзину. Конец сценария <br><br> AF6-4a: Изменение способа употребления пищи <br> 4a.1 Пользователь на странице оплаты заказа нажал кнопку N25 или N26 <br> 4a.2 Система открыла страницу выбора способа употребления пищи <br> 4a.3 Пользователь нажал на кнопку N16 <br> 4a.4 Система открыла страницу оплаты заказа <br> 4a.5 Система отобразила кнопку N25. Конец сценария <br><br> AF6-4b: Изменение способа употребления пищи <br> 4b.1 Пользователь на странице оплаты заказа нажал кнопку N25 или N26 <br> 4b.2 Система открыла страницу выбора способа употребления пищи <br> 4b.3 Пользователь нажал на кнопку N17 <br> 4b.4 Система открыла страницу оплаты заказа <br> 4b.5 Система отобразила кнопку N26. Конец сценария <br><br>
Наименования элементов пользовательского интерфейса|N16: "с собой" <br> N17: "в зале"<br> N20: "Назад" <br> N25: "Заказ: C собой" <br> N26: "Заказ: В зале".
Диаграмма|
...
Краткое описание | 
Участники | 1. Пользователь 
Предусловие | Пользователь зашел в приложение <br> 2. Пользователь уточнил время приготовления заказа [Перейти к UC-8](#5228-Уточнить-время-приготовления-заказа) 
Основной сценарий | 1. Пользователь нажал на кнопку N27  <br> 2. Система вывела страницу оплаты заказа <br> 3. Пользователь ввел номер карты, имя держателя карты, срок действия карты и CVV <br> 4. Система получила подтверждение оплаты <br> 5. Система отправила электронный чек об оплате на E-mail <br> 6. Система открыла страницу подтверждения оплаты <br> 7. Система отобразила номер заказа, адрес ресторана, время готовности заказа. Конец сценария <br><br> 
Альтернативный сценарий| AF1-1: Корректировака заказа <br> 1.1 Пользователь нажал на кнопку N20 <br> 1.2 Пользователь 

Наименования элементов пользовательского интерфейса|N27: "Оплатить заказ" <br> N20: "Назад".
Диаграмма|
...
Альтернативный сценарий| AF8-1a: Заказ на ближайшее время <br> 1a.1 Пользователь нажал на кнопку N19 <br> 1a.2 Система открыла страницу оплаты заказа. Конец сценария <br><br> AF8-1b: Изменение способа употребления пищи <br> 1a.1 Пользователь нажал на кнопку N19 <br> 1a.2 Система открыла страницу оплаты заказа. Конец сценария <br><br>
Наименования элементов пользовательского интерфейса|N19: "Оформить заказ" <br> N22: "Дата" <br> N23: "Час" <br> N24: "Мин" 
Диаграмма|
...
#### 5.2.3.3 Повторить ранее оформленный заказ 
