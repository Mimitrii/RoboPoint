...
[ViewerDiagrams](https://viewer.diagrams.net/?tags=%7B%7D&lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&title=UseCase.drawio&dark=auto#Uhttps%3A%2F%2Fdrive.google.com%2Fuc%3Fid%3D1z7zvJ3zwf_6K0o6VOmXv3SFaJTijvAQr%26export%3Ddownload) <br> 
...
Альтернативный сценарий| AF4-4a: Без просмотра корзины <br> 4a.1. Пользователь выполнил п.1-п.4 основного сценария. Конец сценария.<br><br> AF4-4b: Выбор максимального количества блюд <br> 4b.1. Пользователь выполнил п.1-п.4 основного сценария 28 раз <br> 4b.2 Пользователь нажал на кнопку N10 29 раз <br> 4b.3. Система деактивировала кнопки N10. Конец сценария.<br><br> AF4-10a: Изменение количества блюд <br> 10a.1 Пользователь выполнил п.1-п.9 основного сценария <br> 10a.2 Пользователь изменил количество блюд кнопкой N12 или N13 <br> 10a.3 Система отобразила изменение количества блюда <br> 10a.4 Система отобразила изменение количества блюда <br> 10a.5 Система пересчитала итоговую стоимость заказа Конец сценария. <br><br> AF4-10b: Выбор максимального количества блюд <br> 10b.1 Пользователь выполнил п.1-п.9 основного сценария 28 раз<br> 10b.2 Пользователь нажал на кнопку N12 29 раз <br> 10b.3 Система деактивировала кнопку N12. Конец сценария. <br><br> AF4-10c: Удаление всех блюд из корзины <br> 10c.1 Пользователь выполнил п.1-п.9 основного сценария <br> 10c.2 Пользователь нажал на кнопку N14 <br> 10c.3 Система удалила все блюда из корзины <br> 10c.4 Система обнулила итог <br> 10c.5 Система деактивировала кнопку N18. Конец сценария. <br><br>  
Наименования элементов пользовательского интерфейса|N9: "Категория меню" <br> N10:"Блюдо" <br> N11:"Корзина" <br>  N12:"+" <br>  N13:"-" <br>  N14:"Очистить корзину" <br> N18: "Оформить заказ" <br> N20: "Назад".
...
Основной сценарий | 1. Пользователь нажал на кнопку N15 или N18 <br> 2. Система подтвердила наличие ингредиентов на складе <br> 3. Система сформировала резерв ингредиентов на складе под временный заказ <br> 4. Система открыла страницу выбора способа употребления пищи. Конец сценария.
Альтернативный сценарий| AF5-2a: Отсутствуют ингредиенты для выбранного блюда <br> 2a.1 Система уведомила об отсутствии ингредиентов на складе <br> 2a.2 Система предложила замену отсутствующего блюда <br> 2a.3 Система  скрыла недоступное блюдо в меню <br>  2a.4 Система удалила блюдо с отсутствующими ингредиентами из корзины <br>2a.5 Пользователь нажал на кнопку N10 <br> 2a.6 Система добавила выбранное блюдо в корзину <br> 2a.7 Переход к п.6 основного сценария UC-4 [Перейти к UC-4](#5224-Сформировать-корзину). Конец сценария.<br><br> AF5-2b: Отсутствуют ингредиенты для выбранного блюда <br> 2b.1 Система уведомила об отсутствии ингредиентов на складе <br> 2b.2 Система предложила замену отсутствующего блюда <br> 2b.3 Система  скрыла недоступное блюдо в меню  <br> 2b.4 Система удалила блюдо с отсутствующими ингредиентами <br> 2b.5 Пользователь нажал на кнопку N20 <br> 2b.6 Переход к п.6 основного сценария UC-4 [Перейти к UC-4](#5224-Сформировать-корзину). Конец сценария.<br><br> AF5-2c: Отсутствуют ингредиенты для приготовления нескольких выбранных одинаковых блюд <br> 2с.1 Система уведомила об ограниченном количестве блюд <br> 2с.2 Система предложила замену блюда <br>  2с.3 Пользователь нажал на кнопку N10 <br> 2с.4 Система уменьшила количество одинаковых блюд до доступного количества ингредиентов на складе <br> 2с.5 Система добавила выбранное блюдо в корзину <br> 2c.6 Переход к п.6 основного сценария UC-4 [Перейти к UC-4](#5224-Сформировать-корзину). Конец сценария.<br><br> AF5-2d: Отсутствуют ингредиенты для приготовления нескольких выбранных одинаковых блюд <br> 2d.1 Система уведомила об ограниченном количестве блюд <br> 2d.2 Система предложила замену блюда <br>  2d.3 Пользователь нажал на кнопку N20 <br> 2d.4 Система уменьшила количество одинаковых блюд до доступного количества ингредиентов на складе <br> 2d.5 Переход к п.6 основного сценария UC-4 [Перейти к UC-4](#5224-Сформировать-корзину). Конец сценария.<br><br>  
...
Альтернативный сценарий| AF6-1a: Употребление пищи в ресторане <br> 1a.1 Пользователь нажал на кнопку N17 <br> 1a.2  Система добавила в заказ способ употребления пищи <br> 1a.3 Система открыла страницу выбора времени приготовления блюд. Конец сценария <br><br> AF6-1b: Корректировка наполнения корзины <br> 1b.1 Пользователь нажал на кнопку N20 <br> 1b.2 Система открыла корзину <br> 1b.3 Система удалила временный заказ. Конец сценария <br><br> 
...
| Диаграмма | <img src="images/5_UML/UC_7_OrderPayment.png" width="100" /> <br> [PLANTUML](5_UML/UC_7_OrderPayment.wsd)
...
Предусловия | 1. Пользователь оформил заказ, произвел оплату и получил номер заказа <br> 2. Пользователь находится в Ресторане <br> 3. Пользователь не получил заказ
...
| Диаграмма | <img src="images/5_UML/UC_11_Board.png" width="100" /> <br> [PLANTUML](5_UML/UC_11_Board.wsd)
...
| Диаграмма | <img src="images/5_UML/UC_10_BonusPointsReduction.png" width="100" /> <br> [PLANTUML](5_UML/UC_10_BonusPointsReduction.wsd) 
...
#### 5.2.3.4 Добавление КомбоБургера

Название |UC-14: Добавление КомбоБургера
| ------------- | ------------- |  
Краткое описание | Добавление КомбоБургера для последующей покупки 
Участники | 1. Пользователь 
Предусловия | 1. Пользователь зашел в приложение <br> 2. Пользователь авторизован в системе [Перейти к UC-2](#5222-Авторизоваться-в-системе) 
Постусловия | 1. Заказ в производство поступает только после выполнения оплаты и назначения номера заказа.
Основной сценарий | 1 Пользователь выбрал блюдо КомбоБургер и нажал на кнопку N10 <br> 2 Система открыла страницу редактирования состава КомбоБургера <br> 3 Пользователь выбрал добавил ингредиент и нажал на кнопку N12 <br> 4 Система отобразила изменения <br> 5 Пользователь повторил п.1 -4 необходимое количество раз <br> 6 Система отобразила изменения <br> 7 Пользователь нажал на кнопку N29 <br>8 Система добавила КомбоБургер в корзину, подсветила суммарное количество добавленных блюд над кнопкой N11<br> 9 Система рассчитала итоговую стоимость. Конец сценария.<br><br> |
Альтернативный сценарий| AF14-3a: Выбор максимального количества одного ингредиента <br> 3a.1. Пользователь выполнил п.3 основного сценария для одного ингредиента несколько раз и достиг максимально допустимого количества ингредиента для КомбоБургера <br> 3a.2 Система заблокировала кнопку N12 <br> 3a.3. Продолжение п.5 основного сценария. Конец сценария.<br><br> AF14-3b:  Выбор минимального количества одного ингредиента <br> 3b.1 Пользователь нажал на кнопку N13 для одного ингредиента несколько раз и достиг минимального допустимого количества ингредиента для КомбоБургера <br> 3b.2 Система заблокировала кнопку N13 <br> 3b.3. Продолжение п.5 основного сценария. Конец сценария.<br><br> AF14-3c: Отмена добавления КомбоБургера в корзину <br> 3с.1 Пользователь нажал на кнопку N20 <br> 3с.2 Система закрыла страницу редактирования состава КомбоБургера <br> 3с.3. Система вернула пользователя на страницу с блюдами выбранной категории. Конец сценария.<br><br> 
Наименования элементов пользовательского интерфейса| N9: "Категория меню" <br> N10:"Блюдо" <br> N11:"Корзина" <br>  N12:"+" <br>  N13:"-" <br> N20: "Назад" <br>  N29:"Добавить в корзину".|
| Диаграмма | (1) <img src="images/5_UML/UC_14_CreateBasket.png" width="100" />  <br> [PLANTUML](5_UML/UC_14_CreateBasket.wsd) <br> (2) <img src="images/5_UML/UC_5a_CheckIngredients.png" width="100" /> <br> [PLANTUML](5_UML/UC_5a_CheckIngredients.wsd)
...
1.	Система сохраняет сформированный неоплаченную корзину заказа на мобильном устройстве при закрытии приложения <br> 

Оформление заказа
1. Если пользователь не произвел оплату [Перейти к UC-7](#5227-Произвести-оплату) в течении 30 минут, система удаляет(при помощи шедуллера) временный заказ и созданный под него рецепт в случае добавления КомбоБургера <br>2. Система снимает резерв с ингредиентов установленных временным заказом [Перейти к UC-5](#5225-Проверить-наличие-ингредиентов-на-производстве)