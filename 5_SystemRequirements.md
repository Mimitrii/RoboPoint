...
Оформление заказа
1. Система удаляет временный заказ(шедуллер) если пользователь не произвел оплату [Перейти к UC-7](#5227-Произвести-оплату) в течении 30 минут<br>2. Система снимает резерв с ингредиентов установленных временным заказом [Перейти к UC-5](#5225-Проверить-наличие-ингредиентов-на-производстве)