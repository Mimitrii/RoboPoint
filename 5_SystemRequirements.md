...
Основной сценарий | 1. Пользователь нажал на кнопку N15  <br> 2. Система вывела способы употребления пищи <br> 3. Пользователь нажал на кнопку N2 <br> 4.  Система открыла странцу с блюдами выбранной категории. Конец сценария.
...
<br> 10. Пользователь нажал на кнопку N15 <br> 11. Система подтвердила наличие ингредиентов на складе <br> 12. Система открыла страницу выбора способа употребления пищи

Наименования элементов пользовательского интерфейса|N15: "Оформить заказ" N20: "Назад" .
Диаграмма|
