...
Цель : Проверить, что если пользователь не добавил блюда в корзину то на кнопке "Корзина" не отображается суммарное количество добавленных блюд, а кнопка "Оформить заказ " исчезнет.



Цель : Проверить, что если пользователь выбрал и добавил блюда в корзину, нажал на кнопку "Корзина" перешел на страницу редактирования и удаление добавленных блюд корзины и нажал на кнопку "Очистить корзину" то добавленные блюда удаляться из корзины, а кнопка "Оформить заказ " исчезнет.


Цель : Проверить, что если пользователь выбрал и добавил блюда в корзину в количестве равном 29 штук, то на 29м блюде  
