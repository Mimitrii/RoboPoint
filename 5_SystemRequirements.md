...
[DrawIO](UseCase.drawio)<br> 
[ViewerDiagrams](https://viewer.diagrams.net/?tags=%7B%7D&lightbox=1&highlight=0000ff&edit=_blank&layers=1&nav=1&dark=auto#G1gGc2D9302firTckheYWKjclgMj5nHlrN) <br> 
...
| ------------- | ------------- |  
Краткое описание | Уточнение в заказе времени к кторому необходимо приготовить блюда
...
Участники | 1. Пользователь <br> 2. Менеджер на гостепримстве
...
Альтернативный сценарий|AF9-1: Менеджер на гостепримстве отменил заказ клиента <br> 1. Основной сценарий п. 1 <br> 2. Менеджер на гостепримстве отменил заказ по требованию клиента <br> 3. Система списала начислиленные клиенту баллы по программе лояльности. Конец сценария. 
...
Основной сценарий | 1. Пользователь нажал на кнопку N26  <br> 2. Система расчитала допустимое количество баллов для списания <br> 3. Система проверила наличие баллов  <br> 4. Система уменьшила количество баллов в интерфейсе Приложения <br> 5. Система добавила строчку T1 на странице оплаты заказа <br> 6. Система добавила строчку T2 на странице оплаты заказа <br> 7. Пользователь нажал кнопку N27, переход к п.1 основного сценария UC-7 [Перейти к UC-7](#5227-Произвести-оплату)<br> 8. Система списала баллы с бонусного счета пользователя. Конец сценария. 
...
Наименования элементов пользовательского интерфейса| N20: "Назад" <br> N26: "Списать баллы" <br> N27: "Оплатить заказ" <br> T1:"Списанно баллов" <br> T2:"Итого с учетом скидки" <br> M10: "Отсутствуют бонусные баллы"
Диаграмма|
