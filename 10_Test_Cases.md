...
| 3 | Нажать на кнопку "Корзина" | Открывается страница корзины: Редактирование и удаление добавленных блюд [WF5](8_UI.md#wf-8-Страница-корзины-Редактирование-и-удаление добавленных-блюд). Отображаются добавленные блюда, суммарное количество добавленных блюд, итоговая стоимость заказа |
...
| №  | Описание шага                          | Результат                           |
|----|------------------------------------|--------------------------------------|
| 1  | Открыть страницу выбора категорий блюд и самих блюд [WF5](8_UI.md#wf-8-Страница-выбора-категорий-блюд-и-самих-блюд) | Открывается страница выбора категорий блюд, над кнопкой "Корзина" не отображается количество блюд и итоговая стоимость заказа, кнопка "Оформить заказ " отсутствует.
...
| №  | Описание шага                          | Результат                           |
|----|------------------------------------|--------------------------------------|
| 1  | Открыть страницу выбора категорий блюд и самих блюд [WF5](8_UI.md#wf-8-Страница-выбора-категорий-блюд-и-самих-блюд) | Открывается страница выбора категорий блюд |
